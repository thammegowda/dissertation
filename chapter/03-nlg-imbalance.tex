\chapter{Natural Languages and Type Imbalance}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.5\linewidth]{nmt-arch-classifier.pdf}
...
In the following sections we describe our experiments and analysis to locate the optimal number of BPE merges that achieves the right trade-off for both $C$ and $R$. 
 ...
 \begin{figure}[ht]
  \centering
    \includegraphics[width=0.6\linewidth]{bpe64k-deen-en.pdf}
...
\multirow{4}{1.5cm}{DE$\rightarrow$EN\\EN$\rightarrow$DE} 
    & \multirow{4}{3.5cm}{Europarl v10 \\ WMT13CommonCrawl \\ NewsCommentary v14}
...
\begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=0.58\linewidth]{bleu-deen.pdf}
    \caption{DE$\rightarrow$EN BLEU on NewsTest2019}
    \label{fig:bleu-deen}
\end{subfigure}
\begin{subfigure}{\linewidth}
    \centering
    \includegraphics[width=0.58\linewidth]{bleu-ende.pdf}
...
\begin{figure}[ht]
    \centering    
    \includegraphics[width=0.58\linewidth]{bleu-enhi-enlt.pdf}
...
\begin{subfigure}{\textwidth}
  \centering
  \includegraphics[width=0.6\linewidth,trim={1.4cm 0 0.2cm 16.45cm},clip]{4axv-test-deen-4.5m.pdf}
\end{subfigure}
...
\begin{subfigure}{.32\textwidth}
  \centering
  \includegraphics[width=0.89\linewidth,trim={5.1cm 1.32cm 4.1cm 0},clip]{4axv-test-deen-0.5m.pdf}
  %\caption{1c}
  %\label{fig:sfig2}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
...
\begin{subfigure}{.32\textwidth}
  \centering
  \includegraphics[width=0.89\linewidth,trim={5.1cm 1.32cm 4.1cm 0},clip]{4axv-test-ende-0.5m.pdf}
  %\caption{1c}
  %\label{fig:sfig2}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
...
\begin{subfigure}{.32\textwidth}
  \centering
  \includegraphics[width=0.89\linewidth,trim={5.1cm 1.32cm 4.1cm 0},clip]{4axv-test-enhi-1.3m.pdf}
  %\caption{1c}
  %\label{fig:sfig2}
\end{subfigure}
\begin{subfigure}{.33\textwidth}
  \centering
  \includegraphics[width=0.99\linewidth,trim={5.1cm 1.32cm 1.4cm 0},clip]{4axv-test-enlt-0.6m.pdf}
  %\caption{1c}
  %\label{fig:sfig2}
\end{subfigure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6\linewidth]{corr-deen-test.pdf}
